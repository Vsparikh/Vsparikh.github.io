...
const languages = ["HTML5", "CSS", "Python", "C#", "C", "C++", "Scheme", "Unreal Engine", "Unity", "Git",
    "Linux", "ARM x86", "MIPS assembly", "Raspberry Pi", "Javascript", "Visual Studio", "Perforce", "MySQL"];

counts = [1, 2, 4, 5, 4, 2, 1];
const options = {
    tilt: Math.PI / 9,
